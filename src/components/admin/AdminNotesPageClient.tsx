...
import { deleteMultipleNotesAction, deleteNoteAction, getNotesAdmin, updateNotePublishStatusAction } from '@/app/admin/notes/actions';
import { getSubjectsAction } from '@/app/admin/subjects/actions';
...
export default function AdminNotesPageClient() {
  ...
  if (loading) {
    return <div className="flex h-48 items-center justify-center"><Loader /></div>;
  }
