    ...
    <footer className="bg-card/50 py-4 mt-8 border-t">
      <div className="container mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="text-center sm:text-left text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} <span className="font-bold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">HSC Notes</span>. Some rights reserved.</p>
        </div>
