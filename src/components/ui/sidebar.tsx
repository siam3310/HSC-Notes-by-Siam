...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-2 flex h-5 min-w-5 items-center justify-center rounded-full px-1.5 text-xs font-medium tabular-nums text-primary-foreground bg-primary select-none pointer-events-none",
