...
export default async function Home() {
  const latestNotes = await getLatestNotes(6);
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-12 flex-grow">
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-6 flex-grow min-h-[60vh]">
        ...
        <Link href="/subjects">
           <Button size="default" className="group pl-4 pr-6 h-12 bg-foreground text-background hover:bg-foreground/90 transition-all duration-300 ease-in-out sm:size-lg">
