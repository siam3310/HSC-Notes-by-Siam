  ...
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-6 flex-grow">
      ...
      <p className="max-w-2xl mx-auto text-lg text-muted-foreground">
        Discover a comprehensive collection of notes designed to help you excel in your HSC exams. All notes are collected & organized by <span>Mahamudun Nabi Siam</span>.
      </p>
      <Link href="/subjects">
        <Button size="lg" className="group rounded-full pl-4 pr-6 h-12 bg-foreground text-background hover:bg-foreground/90 transition-all duration-300 ease-in-out">
