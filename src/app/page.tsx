...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-6 flex-grow">
      ...
      <Link href="/subjects">
        <Button size="lg" className="group rounded-full pl-4 pr-6 h-12 bg-foreground text-background hover:bg-foreground/80 transition-all duration-300 ease-in-out hover:scale-105 active:scale-100">
